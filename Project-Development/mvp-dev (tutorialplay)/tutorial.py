...
class TutorialWindow: #defines class handling intruction window
    ...
    def start_game(self):
        """
        Close the welcome screen and launch the playable tutorial.
        """

        print("[TUTORIAL] Welcome screen complete")
        ...
        # Configure Cue 1 after the viewer exists.
