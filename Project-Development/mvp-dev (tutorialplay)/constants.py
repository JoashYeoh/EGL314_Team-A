...
# ---------------------------------------------------------------------------
TUTORIAL_CUE_NONE = 0
TUTORIAL_CUE_ZONE_INTRO = 1
TUTORIAL_CUE_MINIMUM = 2
TUTORIAL_CUE_MULTIPLE_ZONES = 3
TUTORIAL_CUE_READY = 4

TUTORIAL_ZONE_A_START_PERCENT = 50
TUTORIAL_MINIMUM_BUFFER = 0.05
