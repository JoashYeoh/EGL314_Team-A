...
# ---------------------------------------------------------------------------
# Zone Update Size Checker - for tutorial
# ---------------------------------------------------------------------------
def percentage_to_radius(zone, percentage):
    """
    Convert a percentage from 0-100 into a radius between
    the zone's minimum and maximum radius.
    """

    percentage = max(0, min(100, percentage))

    min_radius = zone["min_radius"]
    max_radius = zone["max_radius"]
...
# ---------------------------------------------------------------------------
# Zone Update Size Checker - for game
# ---------------------------------------------------------------------------
