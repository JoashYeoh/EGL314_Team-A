...
# ---------------------------------------------------------------------------
    def draw_tutorial(self):
        ...
        cue = self.game_manager.tutorial_cue

        if cue == TUTORIAL_CUE_ZONE_INTRO:
            self.show_overlay(
                "SAFE ZONE\n\n"
                "This is a safe zone.\n"
                "Keep it from shrinking to minimum.\n\n"
...
# ---------------------------------------------------------------------------
    def draw_gameplay(self):
        ...
        elif self.game_manager.game_state == STATE_TUTORIAL:
            self.hud.set_text(
                f"TUTORIAL\n"
                f"Cue: {self.game_manager.tutorial_cue}"
            )
    ...
    def update_overlay(self):
        ...
        tutorial_cue = self.game_manager.tutorial_cue

        if state == self.last_game_state and tutorial_cue == self.last_tutorial_cue:
            return

        print(
            f"[VIEWER] State -> {state}, "
            f"tutorial cue -> {tutorial_cue}"
        )

        self.last_game_state = state
        self.last_tutorial_cue = tutorial_cue
        ...
        elif state == STATE_WAITING_TO_START:
            self.show_overlay(
                "TUTORIAL COMPLETE\n\n"
